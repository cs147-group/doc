			...
			if (data) {
				$.each(data, function(index, value) {
					...
					if ($.isPlainObject(value)) {
						...
						str.push('<li class="autocomplete" data-icon=' + settings.icon + '><a href="' + settings.link + encodeURIComponent(value) + '" data-transition="' + settings.transition + '">' + settings.labelHTML(value) + '<span class="ui-icon ui-icon-arrow-l ui-icon-shadow autocomplete-fill-icon"></span></a></li>');
					}
				});
			}
		}
